<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:79:"E:\phpStudy\PHPTutorial\WWW\520jiehaoyun.com\addons\cms\view\default\index.html";i:1566056337;s:87:"E:\phpStudy\PHPTutorial\WWW\520jiehaoyun.com\addons\cms\view\default\common\layout.html";i:1566056337;s:91:"E:\phpStudy\PHPTutorial\WWW\520jiehaoyun.com\addons\cms\view\default\common\index_list.html";i:1566056337;s:85:"E:\phpStudy\PHPTutorial\WWW\520jiehaoyun.com\addons\cms\view\default\common\item.html";i:1566056337;s:88:"E:\phpStudy\PHPTutorial\WWW\520jiehaoyun.com\addons\cms\view\default\common\sidebar.html";i:1566056337;}*/ ?>
<!DOCTYPE html>
<!--[if lt IE 7]>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <?php $__8PpgLC6SWo__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","condition"=>"1=isnav"]); if(is_array($__8PpgLC6SWo__) || $__8PpgLC6SWo__ instanceof \think\Collection || $__8PpgLC6SWo__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__8PpgLC6SWo__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
                    <!--判断是否有子级或高亮当前栏目-->
                    <li class="<?php if($nav['has_child']): ?>dropdown<?php endif; if($nav->is_active): ?> active<?php endif; ?>">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <?php $__mInQMvkUqh__ = \addons\cms\model\Channel::getChannelList(["id"=>"sub","type"=>"son","typeid"=>$nav['id'],"condition"=>"1=isnav"]); if(is_array($__mInQMvkUqh__) || $__mInQMvkUqh__ instanceof \think\Collection || $__mInQMvkUqh__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__mInQMvkUqh__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?>
                            <li><a href="<?php echo $sub['url']; ?>"><?php echo $sub['name']; ?></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__mInQMvkUqh__; ?>
                        </ul>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__8PpgLC6SWo__; ?>
                </ul>
            ...
            <div class="swiper-container index-focus">
                ...
                <div id="index-focus" class="carousel slide carousel-focus" data-ride="carousel">
                    <ol class="carousel-indicators">
                        <?php $__VS6hNx5lQn__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"indexfocus","row"=>"5"]); if(is_array($__VS6hNx5lQn__) || $__VS6hNx5lQn__ instanceof \think\Collection || $__VS6hNx5lQn__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__VS6hNx5lQn__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
                        <li data-target="#index-focus" data-slide-to="<?php echo $i-1; ?>" class="<?php if($i==1): ?>active<?php endif; ?>"></li>
                        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__VS6hNx5lQn__; ?>
                    </ol>
                    <div class="carousel-inner" role="listbox">
                        <?php $__pEoPyZeFM9__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"indexfocus","row"=>"5"]); if(is_array($__pEoPyZeFM9__) || $__pEoPyZeFM9__ instanceof \think\Collection || $__pEoPyZeFM9__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__pEoPyZeFM9__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
                        ...
                        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__pEoPyZeFM9__; ?>
                    </div>
            ...
            <div class="panel panel-default index-gallary">
                ...
                <div class="panel-body">
                    <div class="related-article">
                        <div class="row">
                            <!-- S 热门图集 -->
                            <?php $__lVM9s0uDTb__ = \addons\cms\model\Archives::getArchivesList(["id"=>"item","model"=>2,"orderby"=>"views","row"=>"4"]); if(is_array($__lVM9s0uDTb__) || $__lVM9s0uDTb__ instanceof \think\Collection || $__lVM9s0uDTb__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__lVM9s0uDTb__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                            ...
                            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__lVM9s0uDTb__; ?>
                            <!-- E 热门图集 -->
                        </div>
                    </div>
                </div>
                    ...
                    <h3 class="panel-title">
                        ...
                        <div class="more hidden-xs">
                            <ul class="list-unstyled list-inline">
                                <!-- E 栏目筛选 -->
                                <?php $__a1D0pYbRzL__ = \addons\cms\model\Channel::getChannelList(["id"=>"item","condition"=>"'list'=type","limit"=>"6"]); if(is_array($__a1D0pYbRzL__) || $__a1D0pYbRzL__ instanceof \think\Collection || $__a1D0pYbRzL__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__a1D0pYbRzL__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                                <li><?php echo $item['textlink']; ?></li>
                                <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__a1D0pYbRzL__; ?>
                                <!-- E 栏目筛选 -->
                            </ul>
                        </div>
                    </h3>
...
<!-- S 首页列表 -->
<?php $__4HsFtR0jmp__ = \addons\cms\model\Archives::getArchivesList(["id"=>"item","cache"=>"false","orderby"=>"weigh","limit"=>"$offset,10"]); if(is_array($__4HsFtR0jmp__) || $__4HsFtR0jmp__ instanceof \think\Collection || $__4HsFtR0jmp__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__4HsFtR0jmp__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
...
<?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__4HsFtR0jmp__; ?>
<!-- E 首页列表 -->
            ...
            <div class="panel panel-default lasest-update">
                ...
                <div class="panel-body">
                    <ul class="list-unstyled">
                        <?php $__5CT9LMgP2u__ = \addons\cms\model\Archives::getArchivesList(["id"=>"new","row"=>"8","orderby"=>"id","orderway"=>"desc"]); if(is_array($__5CT9LMgP2u__) || $__5CT9LMgP2u__ instanceof \think\Collection || $__5CT9LMgP2u__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__5CT9LMgP2u__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?>
                        <li>
                        ...
                        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__5CT9LMgP2u__; ?>
                    </ul>
                </div>
                <!-- E 最近更新 -->
            </div>
...
<div class="panel panel-default hot-article">
    ...
    <div class="panel-body">
        <?php $__RNUHftqYxM__ = \addons\cms\model\Archives::getArchivesList(["id"=>"item","model"=>1,"row"=>"10","flag"=>"recommend","orderby"=>"id","orderway"=>"asc"]); if(is_array($__RNUHftqYxM__) || $__RNUHftqYxM__ instanceof \think\Collection || $__RNUHftqYxM__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__RNUHftqYxM__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
        ...
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__RNUHftqYxM__; ?>
    </div>
</div>
<!-- E 热门资讯 -->
...
<div class="panel panel-default hot-tags">
    ...
    <div class="panel-body">
        <div class="tags">
            <?php $__HGOcgkAYPf__ = \addons\cms\model\Tags::getTagsList(["id"=>"tag","orderby"=>"rand","limit"=>"30"]); if(is_array($__HGOcgkAYPf__) || $__HGOcgkAYPf__ instanceof \think\Collection || $__HGOcgkAYPf__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__HGOcgkAYPf__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tag): $mod = ($i % 2 );++$i;?>
            <a href="<?php echo $tag['url']; ?>" class="tag"> <span><?php echo $tag['name']; ?></span></a>
            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__HGOcgkAYPf__; ?>
        </div>
    </div>
</div>
<!-- E 热门标签 -->
...
<div class="panel panel-default recommend-article">
    ...
    <div class="panel-body">
        <?php $__21mX0R7nog__ = \addons\cms\model\Archives::getArchivesList(["id"=>"item","model"=>3,"row"=>"10","flag"=>"recommend","orderby"=>"id","orderway"=>"asc","addon"=>"downloads"]); if(is_array($__21mX0R7nog__) || $__21mX0R7nog__ instanceof \think\Collection || $__21mX0R7nog__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__21mX0R7nog__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
        <div class="media media-number">
            <div class="media-left">
                <span class="num"><?php echo $i; ?></span>
            </div>
        ...
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__21mX0R7nog__; ?>
    </div>
</div>
<!-- E 推荐下载 -->
